<x-app-layout>
    <div class="container py-8">
        ...
        <div class="text-lg text-gray-500 mb-12">
            {!!$post->extract!!}
        </div>
                    ...
                    @foreach ($similares as $similar)
                        <li class="mb-4">
                            <a class="flex" href="{{route('posts.show',$similar)}}">
                                ...
                                @else
                                    <img class="w-36 h-20 object-cover object-center" src="https://cdn.pixabay.com/photo/2016/11/19/18/57/godafoss-1840758_960_720.jpg" alt="">
                                @endif
