<nav class="bg-gradient-to-r from-green-400 to-blue-500 shadow-2xl" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
        ...
        @else
          <a href="{{route('login')}}" class="block px-4 py-2 text-sm text-white link" role="menuitem">
            Login
          </a>
          <a href="{{route('register')}}" class="block px-4 py-2 text-sm text-white" role="menuitem">
            Register
          </a>
        @endauth
      </div>
